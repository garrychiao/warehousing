        ...
        <form class="" action="{{ url('/shippment/proforma/'.$records->id)}}" method="post" onkeydown="if(event.keyCode==13){return false;}">
          ...
          <div class="form-group">
            <table class="table table-condensed table-hover table-bordered">
              <tr>
                <th class="success">編號 / ID</th><td><input type="text" class="form-control" name="order_id" value="{{ $records->order_id}}" required></td>
                <th class="success">日期 / Date</th><td><input type="date" class="form-control" name="create_date" value="{{ $records->create_date}}" required></td>
              </tr>
              <tr>
            ...
            <table class="table table-condensed table-hover table-bordered" id="tblInventory">
              ...
              -->
                ...
                <td>
                  ...
                  @else
                    <input type="button" class="btn btn-raised btn-sm btn-danger" onclick="delRow(this)" value="刪除 / Delete">
                  @endif
                </td>
              </tr>
              @endforeach
            ...
            <div class="col-sm-12">
              <table class="table">
                ...
                <tr>
                  ...
                  <td class="col-sm-2"><input type="text" class="form-control" name="sandh" id="sandh" value="{{ $records->sandh}}" onchange="countTotal();"></td>
                  <th class="success col-sm-2">Total Weight: </th>
                  <td class="col-sm-2"><h4 id="FinalWeight">{{ number_format($total_weight,2) }}</h4></td>
                  <th class="success col-sm-2">Total : $</th>
                  <td class="col-sm-2"><h4 id="FinalTotal">{{ number_format($total,2) }}</h4></td>
                </tr>
              </table>
            </div>
            <div class="col-sm-12">
