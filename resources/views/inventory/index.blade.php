    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="btn-group btn-group-justified">
          ...
          <a href="/inventory/create"><button type="button" class="btn btn-primary btn-raised">新增 / create</button></a>
        </div>
      </div>
      <div class="col-sm-7">
          @if (count($lists) > 0)
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th>品名<br><small>Item Name</small></th>
                <th>目前庫存<br><small>Inventory</small></th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <button type="button" target="center" class="btn btn-info btn-raised" onclick="window.location.href='{{ URL::route('inventory.show', $list->id) }}'">Details</button>
          ...
          <form class="form-horizontal" action="{{ url('/inventory/'.$show->id)}}" method="post" role="form">
            ...
            <div class="form-group">
              <table class="table table-bordered table-condensed">
                ...
                <tr>
                  <th>品名<br>Item ID</th><td><input type="text" class="form-control" name="item_name" value="{{ $show->item_name }}"></td>
                  <th>圖號<br>Category</th><td><input type="text" class="form-control" name="graph_id" value="{{ $show->graph_id }}"></td>
                </tr>
                <tr>
                  <th>庫存<br>Item ID</th>
                  <td>
                  ...
                  <th>平均成本<br>Category</th>
                  <td>
                    <h4>{{ number_format( $show->avg_cost ,2)}}</h4>
                    <input type="text" class="form-control hidden" name="avg_cost" value="{{ $show->avg_cost }}">                  </td>
                </tr>
                <tr class="success">
                  <th colspan="4">價格區間 (Pricing Range)</th>
                </tr>
                <tr>
                  <th>區間1<br> Range1</th><td><input type="text" class="form-control" name="price1" value="{{ $show->price1 }}"></td>
                  <th>區間2<br> Range2</th><td><input type="text" class="form-control" name="price2" value="{{ $show->price2 }}"></td>
                </tr>
                <tr>
                  <th>區間3<br> Range3</th><td><input type="text" class="form-control" name="price3" value="{{ $show->price3 }}"></td>
                  <th>區間4<br> Range4</th><td><input type="text" class="form-control" name="price4" value="{{ $show->price4 }}"></td>
                </tr>
                <tr>
                  <th>區間5<br> Range5</th><td><input type="text" class="form-control" name="price5" value="{{ $show->price5 }}"></td>
                  <th>區間6<br> Range6</th><td><input type="text" class="form-control" name="price6" value="{{ $show->price6 }}"></td>
                </tr>
                <tr class="success">
